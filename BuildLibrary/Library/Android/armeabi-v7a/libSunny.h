...
*/
extern GoUint8 Java_com_SunnyNet_api_SetIeProxy(GoUintptr envObj, GoUintptr clazz, GoInt64 SunnyContext, GoUint8 Off);
...
*/
extern GoUint8 Java_com_SunnyNet_api_SocketClientDial(GoUintptr envObj, GoUintptr clazz, GoInt64 Context, GoUintptr addr, GoUintptr call, GoUint8 isTls, GoUint8 synchronous, GoUintptr ProxyUrl, GoInt64 CertificateContext, GoInt64 OutTime);
...
*/
extern GoUint8 Java_com_SunnyNet_api_WebsocketDial(GoUintptr envObj, GoUintptr clazz, GoInt64 Context, GoUintptr URL, GoUintptr Heads, GoUintptr call, GoUint8 synchronous, GoUintptr ProxyUrl, GoInt64 CertificateConText, GoInt64 outTime);
...
*/
extern GoUint8 SocketClientDial(GoInt Context, char* addr, GoInt call, GoUint8 isTls, GoUint8 synchronous, char* ProxyUrl, GoInt CertificateConText, GoInt OutTime);
